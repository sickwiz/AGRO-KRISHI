...
<div class="navbar navbar-inverse set-radius-zero" >
    ...
    <div class="col-md-9 col-md-offset-1">
        <h3 align="center">ADD EQIPMENTS FORM</h3>
                        </div>
                        <div class="panel-body">
                            <form method="POST" action="equipment_back.php">
<div class="form-group">
    <br/>
    <br/>
    <div class="form-group">
    <label><p> ENTER EQUIPMENT NAME </p> </label>
    <br>
    <select name='equip' class="form-control">
  <option default>ENTER THE EQUIPMENT</option>
...
<div class="form-group">
    <label><p>QUANTITY OF THE EQUIPMENT</p></label>
<input class="form-control" type="number" name="quant" id="quant" required/>
</div>
<div class="form-group">
    <label><p>RENT PER DAY OF THE EQUIPMENT</p></label>
<input class="form-control" type="text" name="rent" id="RENT" required/>
</div>
