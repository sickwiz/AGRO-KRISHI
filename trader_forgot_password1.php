...
<form role="form" method="post" action='trader_forgot_password1_backend.php'>
...
<input class="form-control" type="text" name="security_question_answer"  />
 ...
 <button type="submit" name="forgot" class="btn btn-info">Submit</button><a href="TRADER_login.php">Login</a> 
</form>
 </div>
</div>
    </div>
